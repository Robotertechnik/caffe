...
for in_idx, in_ in enumerate (inputs):
    ...
    txt = open('convert_lmdb_camvid/inputs/input-'+str(in_idx+1).zfill(5)+'.txt','w') #creates txt file for the groundtruth
