...
base_weights = 'vgg16-fc.caffemodel'
...
for it in range(niter):
    ...
    if it % 500 ==0:
        ...
        solver.net.save('fcn-vgg16-32s/fcn-vgg16-bvlc_camvid_finetune_iter_' + repr(it) + '.caffemodel')
        np.save('fcn-vgg16-32s/loss-vgg16-bvlc_camvid_finetune_iter_' + repr(it) + '.npy',train_loss)
print 'done'
