...
base_weights = '../Alexnet_32s/snapshot/train_iter_500.caffemodel'
...
for it in range(niter):
    ...
    if it % 500 ==0:
        ...
        solver.net.save('fcn-alexnet-16s/fcn-alexnet-bvlc_camvid_finetune_iter_' + repr(it) + '.caffemodel')
        np.save('fcn-alexnet-16s/loss-alexnet-bvlc_camvid_finetune_iter_' + repr(it) + '.npy',train_loss)
print 'done'
